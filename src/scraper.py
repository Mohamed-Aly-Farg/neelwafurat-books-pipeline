...
def get_book_details(book_url):
    ...
    try:
        ...
        try:
            details_container = soup.find("div", {"class": "col-xs-12 col-s-12 col-md-6 col-lg-6-5"})
            title = details_container.find('h1', {'class': 'p-title'}).text.strip()
...
def main():
    ...
    book_containers = soup.find_all('div', {'class': 'col-xs-6 col-s-4 col-lg-3 col-xxl-3 col-3xl-2'})
